...
public class DeCompressionBolt extends BaseRichBolt {
    private static Logger LOG = LoggerFactory.getLogger(DeCompressionBolt.class);
    ...
    public void execute(Tuple tuple) {
        ...
        if (data instanceof byte []) {
            ...
            try {
                byte []decompressed = Snappy.compress(inData);
