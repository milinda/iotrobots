...
public class CompressionBolt extends BaseRichBolt {
    private static Logger LOG = LoggerFactory.getLogger(CompressionBolt.class);
    ...
    public void execute(Tuple tuple) {
        ...
        if (data instanceof byte []) {
            ...
            try {
                ...
                outputCollector.emit(Arrays.<Object>asList(compressed, sensorID, time));
            } catch (IOException e) {
