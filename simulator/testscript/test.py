...
sshNZ.connect('10.39.1.18', username='ubuntu', key_filename='skamburu-key')

sshBR = paramiko.SSHClient()
sshBR.set_missing_host_key_policy(paramiko.AutoAddPolicy())
sshBR.connect('10.39.1.28', username='ubuntu', key_filename='skamburu-key')

sshI = paramiko.SSHClient()
sshI.set_missing_host_key_policy(paramiko.AutoAddPolicy())
sshI.connect('10.39.1.26', username='ubuntu', key_filename='skamburu-key')
