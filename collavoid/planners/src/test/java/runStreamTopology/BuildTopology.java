...
import cgl.iotrobots.collavoid.topologyStreaming.*;
...
//        );
    ...
    private void buildTopology() {
        ...
        builder.setBolt(Constant_storm.Components.LOCAL_PLANNER_COMPONENT, new LocalPlannerBolt(), 2)
        ...
        builder.setBolt(Constant_storm.Components.GET_MINKOWSKI_FOOTPRINT_COMPONENT, new GetMinkowskiFootprintBolt(), 2)
                ...
                .fieldsGrouping(Constant_storm.Components.AGENT_COMPONENT,
                        ...
                        new Fields(Constant_storm.FIELDS.SENSOR_ID_FIELD));
//
        builder.setBolt(Constant_storm.Components.AGENT_STATE_COMPONENT, new AgentStateBolt(), 2)
                .fieldsGrouping(Constant_storm.Components.ODOMETRY_TRANSFORM_COMPONENT,
                        new Fields(Constant_storm.FIELDS.SENSOR_ID_FIELD))
