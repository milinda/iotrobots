...
public class VelCmdPubBolt_old extends BaseRichBolt {
    ...
    public void execute(Tuple tuple) {
        if (sensorID == null) {
            ...
            String queueName = exchange + Constant_msg.RMQ_QUEUE_PREFIX + Constant_msg.KEY_VELOCITY_CMD + Constant_msg.RMQ_QUEUE_SUFFIX;
