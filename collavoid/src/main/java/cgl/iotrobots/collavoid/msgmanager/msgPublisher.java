...
import cgl.iotrobots.collavoid.utils.VO;
...
public class msgPublisher {
        ...
        public void publishHoloSpeed(Vector2 pos, Vector2 vel, String base_frame, String name_space, Publisher speed_pub) {
    ...
    public void publishVOs(Vector2 pos, List<VO> truncated_vos, boolean use_truncation, String base_frame, String name_space, Publisher vo_pub){
        visualization_msgs::Marker line_list;
        line_list.header.frame_id = base_frame;
        line_list.header.stamp = ros::Time::now();
        line_list.ns = name_space;
    ...
    public void publishPoints(Vector2& pos, List<VelocitySample>& points, String base_frame, String name_space, Publisher samples_pub){
    ...
    public void publishOrcaLines(List<Line>& orca_lines, Vector2& position, String base_frame, String name_space, Publisher line_pub){
        visualization_msgs::Marker line_list;
        line_list.header.frame_id = base_frame;
        line_list.header.stamp = ros::Time::now();
        line_list.ns = name_space;
    ...
    public void fillMarkerWithROSAgent(MarkerArray marker, ROSAgent agent, String base_frame, String name_space) {
