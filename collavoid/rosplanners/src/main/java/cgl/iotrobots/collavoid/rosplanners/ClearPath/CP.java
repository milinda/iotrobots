package cgl.iotrobots.collavoid.rosplanners.ClearPath;

import cgl.iotrobots.collavoid.rosplanners.Comparators.VelocitySamplesComparator;
...
public class CP {
    ...
    public static ConvexHullPoint[] convexHull(ConvexHullPoint[] P, boolean sorted) {
        ...
        if (!sorted)
            Arrays.sort(P, new VectorsLexigraphicComparator());
