package cgl.iotrobots.collavoid.rosplanners.NHORCA;

import cgl.iotrobots.collavoid.rosplanners.utils.EPSILON;
import cgl.iotrobots.collavoid.rosplanners.utils.Line;
...
public class NHORCA {
    ...
    public static double calculateMaxTrackSpeedAngle(double T, double theta, double error, double max_vel_x, double max_vel_th, double v_max_ang){
        ...
        //set theta to positive
            return Math.min(utils.sign(theta) * error * max_vel_th / theta, max_vel_x);
    }
